...
Grok has two hook surfaces: the tracked project files `.grok/hooks/fm-primary-*` for the primary session, and the global `~/.grok/hooks/fm-turn-end*` spawn marker for crew workers.
